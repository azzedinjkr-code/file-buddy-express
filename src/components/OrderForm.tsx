...
export function OrderForm() {
  ...
  if (done) {
    return (
      <section id="order" className="mx-auto w-full max-w-md scroll-mt-24 px-4 pb-6 pt-10">
  ...
  return (
    <section id="order" className="mx-auto w-full max-w-lg px-4 pt-1 pb-1">
      <form onSubmit={submit} noValidate className="overflow-hidden rounded-3xl border border-border bg-card shadow-soft">
        <div className="bg-[linear-gradient(135deg,var(--cta)_0%,oklch(0.45_0.13_175)_100%)] px-6 py-4 text-center">
          <h2 className="text-[22px] font-black tracking-tight text-cta-foreground">استمارة الطلب</h2>
        </div>
        ...
        <button type="submit" disabled={sending} aria-busy={sending} className="btn-cta-pro w-full group">
          {sending ? (
            <>
