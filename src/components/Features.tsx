...
const FEATURES = [
  ...
  { icon: Backpack, title: "تصميم عصري 2026", desc: "تصميم أنيق وعصري بطابع شبابي — خيار مثالي للمدرسة والاستخدام اليومي.", accent: "from-blue-500 to-violet-500", bg: "bg-blue-50 text-blue-600 border-blue-100" },
];

export function Features() {
  return (
    <section className="mx-auto w-full max-w-3xl px-4 pt-0 pb-5">
